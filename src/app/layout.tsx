...
function Content({ children }: { children: React.ReactNode }) {
  ...
  return (
    <TRPCProvider>
      <header className="fixed top-0 left-0 right-0 z-50 flex h-8 justify-between border-b bg-white bg-opacity-50 p-1 backdrop-blur-sm dark:bg-gray-950 dark:bg-opacity-50">
        <Link
